...
const ValidarCuentaUsuario = ({ apodo, code }) => {
    ...
    <div style="background-color: lightblue; margin: 1em 0px; padding: 0.5rem; border-radius: 1.5rem 3rem; width: 100%; box-sizing: border-box; justify-content: center; text-align: center;"><span style="text-align: center;"> Mateo's Stage -By Alberto-</span></div>
    </div>`
    return { asunto: asunto, htmlContenido: htmlContenido }
}
