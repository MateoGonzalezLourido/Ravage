...
> El proyecto actualmente apenas tiene documentacion e issues claros actualmente,para no retrasar el desarrollo, debido a que no hay participación externa.Si alguien quiere contribuir se actualizará todo
